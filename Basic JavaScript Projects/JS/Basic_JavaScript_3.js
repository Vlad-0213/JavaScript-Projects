...
function multiplication() {
    ...
    document.getElementById("multiplication") .innerHTML = "7 X 10 = " + simple_Math;
}
...
function more_Math() {
    ...
    document.getElementById("more_Math").innerHTML = "2 plus 2, multiplied by 10,\
     divided in half and then subtracted by 5 equals " + simple_Math;
}

function modulus_operator () {
    var simple_Math = 50 % 5;
    document.getElementById("mod_operator") .innerHTML = "When you divide 50 by 5  you have a\
    remainder of: " +  simple_Math;
}

function nagation_operator() {
    var x = 10;
    document.getElementById("nag_opr") .innerHTML = -XMLDocument;
}
