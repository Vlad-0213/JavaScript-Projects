...
function checkWinConditions() {
    ...
    //and 9 squares are selected, the code executes.
        ...
        audio('./media/elaborate_thunder.mp3');
...
function animateLineDrawing() {
    ...
    c.lineWidth = 10;
    //This method setd the color of our line.
    c.strokeSyle = 'rgba(70,255,33, .8)';
    ...
    if (x1 <= x2 && y1 >= y2) {
        if (x < x2) { x += 10; }
        if (y > y2) { y -= 10; }
        if (x >= x2 && y <= y2) { cancelAnimationFrame(anumationLoop); }
    }
...
audio('./media/Crowd_Aplause.mp3');
//Thiis line calls our main animation loop.
animateLineDrawing();
